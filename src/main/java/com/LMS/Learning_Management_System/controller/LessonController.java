...
public class LessonController {
    ...
    public ResponseEntity<List<LessonDto>> getAllLessons(@PathVariable int courseId , HttpServletRequest request) {
        try {
    ...
    public ResponseEntity<LessonDto> getLessonById(@PathVariable int lessonId , HttpServletRequest request) {
        try {
